...
def check_binary_search_tree_(root, min_val=0, max_val=100):
    if root is None:
        return True
    ...
    return (check_binary_search_tree_(root.left, min_val, root.data - 1) and
            check_binary_search_tree_(root.right, root.data + 1, max_val))
